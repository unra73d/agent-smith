...
forwarding text content deltas to a write channel, and accumulating tool-call deltas by index
until the stream terminates with `[DONE]` or the context is cancelled.
